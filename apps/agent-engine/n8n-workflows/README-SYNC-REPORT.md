...
**Tổng cộng 34 workflow đã import + activate trên `https://n8n-happyhomethanhhoa.bdsg.land`.**
...
N8N_HOT_LEAD_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/hot-lead-alert
N8N_COMMISSION_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/commission-calc
N8N_WELCOME_REGISTER_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/welcome-register
N8N_CUSTOMER_DRIP_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/register-drip
N8N_SALE_ESCALATION_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/sale-escalation
N8N_TRAINING_COMPLETE_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/training-complete
N8N_DEAL_CLOSED_TEAM_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/deal-closed-team
N8N_MARKETING_CAMPAIGN_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/marketing-campaign
N8N_EVENT_CREATE_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/event-create
N8N_REFERRAL_FIRST_WEBHOOK_URL=https://n8n-happyhomethanhhoa.bdsg.land/webhook/referral-first
```
...
CHATWOOT_HOT_LEAD_WEBHOOK=https://n8n-happyhomethanhhoa.bdsg.land/webhook/chatwoot-hot-lead
CHATWOOT_EMAIL_INBOUND_WEBHOOK=https://n8n-happyhomethanhhoa.bdsg.land/webhook/chatwoot-email-inbound

# Open-Notebook → n8n
NOTEBOOK_PUBLIC_SOURCE_WEBHOOK=https://n8n-happyhomethanhhoa.bdsg.land/webhook/notebook-public-source

# Meta Business Suite → n8n (FB Lead Ads webhook)
FB_LEAD_WEBHOOK=https://n8n-happyhomethanhhoa.bdsg.land/webhook/fb-lead
```
...
### Chatwoot
```
CHATWOOT_API_URL=https://chat-happyhomethanhhoa.bdsg.land
CHATWOOT_API_TOKEN=mjmruQEbfat58WRvT3rcXm9o
```

### Telegram (sau khi tạo bot qua @BotFather)
```
TELEGRAM_BOT_TOKEN=<paste vào n8n credential "Happy Home Sale Bot" thay cho REPLACE_TELEGRAM_CREDENTIAL_ID>
...
WP_URL=https://blog-happyhomethanhhoa.bdsg.land
...
SENDGRID_FROM_EMAIL=marketing@bdsg.land
...
2. Set `HH_API_URL`, `INTERNAL_WEBHOOK_TOKEN`, `ANTHROPIC_API_KEY` trong n8n env.
3. Paste 10 webhook URL ở mục "Railway agent-engine env" vào Railway service `shophousehappyhomethanhhoa` → Redeploy.
...
12. **Meta Lead Ads webhook:** Meta Business Suite → Instant Forms → cấu hình webhook https://n8n-happyhomethanhhoa.bdsg.land/webhook/fb-lead.
