    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-brand-700">
          Cập nhật hồ sơ khách hàng và quản lý tài khoản của bạn.
        </p>
      </header>
      ...
      >
        <div className="flex flex-wrap items-center gap-5 border-b border-brand-100 pb-5">
          <div className="h-20 w-20 overflow-hidden rounded-full bg-gradient-to-br from-sky-400 to-indigo-500">
            {avatar ? (
          ...
          <div>
            <label className="cursor-pointer rounded-lg border border-brand-100 px-3 py-2 text-sm font-medium text-brand-800 hover:border-indigo-400">
              Đổi ảnh đại diện
              <input
                type="file"
                accept="image/*"
