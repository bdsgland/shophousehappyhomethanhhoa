#!/usr/bin/env python3
"""Giải nén CHỈ tài liệu văn bản từ các file zip Happy Home Thanh Hóa.

- Đọc tất cả ~/Downloads/Happy Home Thanh Hóa-*.zip
...
DST_DIR = Path("/Users/phamvanthu/Documents/Agent-Proptech/data/projects/happy-home-thanh-hoa")
DOC_EXTS = {".pdf", ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".txt"}
ZIP_GLOB = "Happy Home Thanh Hóa-*.zip"
